...
import ServiceLayer.LabService;

import javax.swing.JOptionPane;

public class LAB extends javax.swing.JFrame {

    private final LabService ls;
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txtchair, javax.swing.GroupLayout.DEFAULT_SIZE, 311, Short.MAX_VALUE))
                            .addComponent(txttable, javax.swing.GroupLayout.PREFERRED_SIZE, 311, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Laboratory l = new Laboratory(txtlabno.getText(), Integer.parseInt(txttable.getText()), Integer.parseInt(txtchair.getText()));
            boolean result = ls.AddHall(l);
            if (result == true) {
...
//        try{
//        Laboratory a=new Laboratory(txtlabno.getText(), Integer.parseInt(txttable.getText()), Integer.parseInt(txtchair.getText()));
//        Lablist.add(a);
//        }catch(NumberFormatException e)
//        {
//         JOptionPane.showMessageDialog(rootPane, "Empty Value or error input", "Info", 0);
